...
| [0005](0005-mcp-secret-injection.md) | MCP Secret Injection: settings.local.json + Windows User Environment | Accepted | 2026-05-05 | SetEnvironmentVariable (Windows) + settings.local.json env key as injection mechanisms; shell export rejected as unreliable for non-interactive spawners |
